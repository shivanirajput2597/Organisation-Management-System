...
public class employee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        l5.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        ...
        l6.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        ...
        getContentPane().add(l6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 130, 20));

        l7.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        ...
        l8.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        l8.setForeground(new java.awt.Color(255, 255, 255));
        l8.setText("Qualification");
        getContentPane().add(l8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 120, 20));

        l9.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        l9.setForeground(new java.awt.Color(255, 255, 255));
        l9.setText("High School (year)");
        getContentPane().add(l9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 350, 130, -1));

        l10.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        l10.setForeground(new java.awt.Color(255, 255, 255));
        l10.setText("Intermediate(year)");
        getContentPane().add(l10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 380, 130, -1));

        l11.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        l11.setForeground(new java.awt.Color(255, 255, 255));
        l11.setText("Graduation(year)");
        getContentPane().add(l11, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 410, 120, -1));

        l12.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        l12.setForeground(new java.awt.Color(255, 255, 255));
        l12.setText("Post Graduation(year)");
        getContentPane().add(l12, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 440, -1, -1));
        ...
        getContentPane().add(t1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 130, -1));
        ...
        getContentPane().add(t2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 100, 130, -1));
        ...
        buttonGroup1.add(r1);
        r1.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        r1.setText("Male");
        r1.setToolTipText(" ");
        ...
        buttonGroup1.add(r2);
        r2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        r2.setText("Female");
        getContentPane().add(r2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 180, 80, -1));
        ...
        getContentPane().add(t5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 150, -1));
        ...
        getContentPane().add(t6, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 380, 150, -1));
        ...
        getContentPane().add(t7, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 410, 150, -1));

        t8.setToolTipText("Type From Where You have Done Post Graduation");
        getContentPane().add(t8, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 440, 150, -1));

        l14.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        l14.setForeground(new java.awt.Color(255, 255, 255));
        l14.setText("Address");
        getContentPane().add(l14, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 40, 80, 20));

        l15.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        ...
        l16.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        l16.setForeground(new java.awt.Color(255, 255, 255));
        l16.setText("Email");
        getContentPane().add(l16, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 60, 20));

        l17.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        l17.setForeground(new java.awt.Color(255, 255, 255));
        l17.setText("Department");
        getContentPane().add(l17, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 250, 100, 20));

        t11.setToolTipText("Type where you worked previously");
        getContentPane().add(t11, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 300, 190, -1));
        ...
        getContentPane().add(b1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 410, 90, -1));
        ...
        getContentPane().add(b2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 410, 90, -1));
        ...
        getContentPane().add(b3, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 410, 100, -1));

        b4.setBackground(new java.awt.Color(255, 255, 255));
        b4.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        b4.setText("FILL DETAILS");
        b4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                b4ActionPerformed(evt);
            }
        });
        getContentPane().add(b4, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 450, 130, -1));
        ...
        getContentPane().add(b5, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 450, 90, 30));

        b6.setBackground(new java.awt.Color(255, 255, 255));
        b6.setFont(new java.awt.Font("Segoe Script", 1, 18)); // NOI18N
        b6.setText("Back");
        ...
        getContentPane().add(b6, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 510, 100, 30));
        ...
        getContentPane().add(c1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 60, 130, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 130, 190, -1));

        t12.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "021 Production", "022 Research and Development", "033 Marketing", "044 Human Resource Management" , "055 Information Technology" ,"066 Accounting and Finance"}));
        t12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t12ActionPerformed(evt);
            }
        });
        getContentPane().add(t12, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 250, 190, 20));
        getContentPane().add(t9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 220, 190, -1));
...
String eid, fname,lname,gen=null,aadhar,
Qh,phno,Qs,Qg,Qpg,Qt,addr,email,dept,exp;
int d,m,y;
eid=t1.getText();
fname=t2.getText();
lname=t3.getText();
...
exp=t10.getText();
email=t11.getText();
dept=t12.getSelectedItem().toString().substring(0, 3);
    ...
    try
{
  ...
  /* String A="Insert into emp values('"+eid+"','"+fname+"','"+lname+"','"+dob+"',"
           + "'"+gen+"','"+aadhar+"','"+phno+"','"+Qh+"','"+Qs+"','"+Qg+"','"+Qpg+"',"
           +"','"+exp+"','"+email+"','"+
            dept+"','"+addr+"');";*/
String query = " insert into emp (eid, fname, lname, dob, gen, aadhar, phno, Qh, Qs, Qg, Qpg, exp, email, dept, addr)"
        + " values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
      ...
      preparedStmt.setString  (5, gen);
      preparedStmt.setString (6, aadhar);
      preparedStmt.setString (7, phno);
      preparedStmt.setString (8, Qh);
      preparedStmt.setString  (9, Qs);
      preparedStmt.setString (10, Qg);
      preparedStmt.setString (11, Qpg);
      preparedStmt.setString (12, exp);
      preparedStmt.setString (13, email);
      preparedStmt.setString (14, dept);
      preparedStmt.setString (15, addr);
...
String eid, fname,lname,dob,gen=null,aadhar=null,
        Qh,phno,Qs,Qg,Qpg,Qt,addr,email,dept,exp;
...
{ try
{
   ...
   /*String A=("Insert into emp values('"+eid+"','"+fname+"','"+lname+"','"+dob+"'"
           + ",'"+gen+"','"+aadhar+"','"+phno+"','"+Qh+"','"+Qs+"','"+Qg+"',"
           + "'"+Qpg+"','"+exp+"','"+email+"','"+ dept+"','"+addr+"');");*/
   String query = " insert into emp (eid, fname, lname, dob, gen, aadhar, phno, Qh, Qs, Qg, Qpg, exp, email, dept, addr)"
        + " values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
//t13.setEnabled(true);
String eid, fname,lname,gen=null,aadhar=null,Qh,phno,
Qs,Qg,Qpg,Qt,addr,email,dept,exp,h,h1,h2,n;
int dob;
n=t1.getText();
String A;
{ try
